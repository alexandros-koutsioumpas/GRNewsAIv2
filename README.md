...
## 🧠 Tips
 ...
 - Με 10 RSS feed και `max_articles=25` σε ένα M4 MacBook Pro η παραγωγή του δελτίου διαρκεί ~50min. Με 3 RSS feed στο ίδιο μηχάνημα η παραγωγή του δελτίου διαρκεί ~10min. Γενικά σε PC που δεν έχουν GPU και το inference γίνεται μόνο με CPU, αναμένεται το runtime να είναι αρκετά μεγαλύτερο και συνίσταται η μείωση των πηγών RSS σε τρεις.
